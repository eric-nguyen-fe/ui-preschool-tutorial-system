...
const DuarationView: React.FC<DuarationViewProps> = ({
  ...
  <div className="m-duaration">
    <div className="m-duaration_btn" onClick={onClickPrev}>
      <Icon iconName="left_feild" size="10x7" />
    </div>
    <Typography content={duarationTime || 'Hello world'} modifiers={['center', 'sonic-silver', 'capitalize', '16x24', '500']} />
    <div className="m-duaration_btn" onClick={onClickNext}>
      <Icon iconName="right_feild" size="10x7" />
    </div>
  </div>
);

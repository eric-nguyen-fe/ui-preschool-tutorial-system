      ...
      <div className="o-position_main">
        <div className="o-position_desc">
          ...
          <div className="o-position_title">
            <Typography type="p" modifiers={['goldenrod', '700', '20x30', 'center', 'uppercase']} content={t(`${nameBooking[indexView]}`) || ''} />
          </div>
          <div className="o-position_session">
            ...
            {toggle ? (
              ...
              <div className="o-position_textAdd" onClick={() => setToggle(!toggle)}>
                ...
                <Typography modifiers={['goldenrod', '700', 'normal']} content={t(`${nameButtonAddItem[indexView]}`) || ''} />
              </div>
            )}
        ...
        <div className="o-position_btn">
          ...
          {subBtnText && indexView !== 0 && (
            ...
            >
              <Typography modifiers={['700', '16x24', 'uppercase']} content={subBtnText} />
            </Button>
          )}
          {btnText && (
            <Button

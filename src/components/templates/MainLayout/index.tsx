...
export const optionSideBar = [
  {
    id: 7, icon: 'dashboard', title: 'Dashboard', child: false, slug: '/',
  },
  {
    id: 0, icon: 'manager', title: 'Calendar', child: false, slug: '/calendar',
  },
  {
    id: 1, icon: 'gradution', title: 'Class Management', child: false, slug: '/manager/class',
  },
  {
    id: 4,
    icon: 'person',
  ...
  {
    id: 5, icon: 'teacher', title: 'Student Management', child: false, slug: '/manager/student',
  },
  {
    id: 8, icon: 'money', title: 'Bill Management', child: false, slug: '/setting',
  },
...
export const optionSideBarMobile = [
  ...
  {
    id: 1, icon: 'gradution', title: 'Class Management', child: false, slug: '/comming-soon/coupon',
  },
  {
    id: 4,
    icon: 'person',
  ...
  {
    id: 5, icon: 'teacher', title: 'Student Management', child: false, slug: '/department',
  },
  {
    id: 8, icon: 'money', title: 'Bill Management', child: false, slug: '/setting',
  },
...
const MainLayout: React.FC<MainLayoutProps> = ({ children, isCalendarLayout, isShowBarLayout = false }) => {
  ...
  const optionsProfile = [
    ...
    {
      id: 0, name: t(Guest ? 'menu.logout' : 'login.login'), slug: '/login', click: handelLogout
    }
  ];
  ...
  const headerData = [
    { id: 0, name: t('header_list.schedule'), slug: '/' },
    { id: 1, name: t('header_list.portal'), slug: 'http://portal.dododo.services/login' },
    { id: 2, name: t('header_list.room_list'), slug: ' http://remotedu.castis.io' },
  ];
  return (
    <div>
      <ToastNotify />
        ...
        <div className={`t-layout_wrapper  ${showSideBar ? 'showfull' : ''} `}>
          ...
          <div className="t-layout_wrapper_header">
            <Header
              ...
              headerData={Guest ? headerData : headerData.slice(0, -1)}
            />
          </div>

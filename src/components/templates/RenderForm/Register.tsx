...
const Register: React.FC<RegisterFormProps> = ({
  ...
  const list = [
    { id_selection: 1, label: '1', _values: 'Teacher' },
    { id_selection: 2, label: '2', _values: 'Student' },
  ];
  ...
  return (
    <form onSubmit={handleSubmit(onSubmitRegister)}>
      ...
      />
      <div className="t-form_register-pass">
        <Input
          id="password"
      ...
      <div className="t-form_btn">
        <Button type="submit" modifiers={['gold']}>
          <Typography content={t('signup.register') || ''} modifiers={['white', '700', '18x32', 'uppercase']} />
        </Button>
      </div>
